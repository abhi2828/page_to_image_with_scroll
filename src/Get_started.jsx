      ...
      <div className="outer_body fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav navbar-sidenav" id="exampleAccordion">
              <li className="nav-item dash_board dash_board_active" data-toggle="tooltip" data-placement="right" title="Get started">
        ...
        <div className="content-wrapper">
                        ...
                        <div className="d-flex flex-row align-items-center mt-3 mb-4">
                          <div className="card bg-light mx-auto" data-original-title title>
                            <div className="card-body">
                              ...
                              <button id="af-copy-clipboard" className="btn btn-primary mr-2 af-pointer mt-3">
                                Copy to clipboard
                </button>
                              <a id="af-launch-in-new-tab" className="btn btn-primary mt-3 mr-2 af-pointer" href="https://api.apiflash.com/v1/urltoimage?access_key=20ebab4a09ac4d74b800dc2a91969d77&url=http://google.com" target="_blank" rel="nofollow">
                                Launch in new tab
                </a>
                              <div className="mt-2">
          ...
          <NavLink exact to='' onclick="event.preventDefault(); $crisp.push(['do', 'chat:open'])" className="af-pointer" style={{ color: 'rgb(92 76 173)' }}>
                          Chat with us live
              <i className="fas fa-comment-alt" style={{ margin: '0 10px' }}></i></NavLink>
                      </div>
                    </div>
                  </div>
                </div>
